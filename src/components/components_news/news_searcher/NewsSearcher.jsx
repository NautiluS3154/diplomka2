...
import styles from './NewsSearcher.module.css'
const NewsSearcher = () => {
    return (
        <div className={styles.container}>
            <div className={styles.wrapp}>
                <div className={styles.mini_container}>
                    <span className={styles.title_one}>Home</span>
                    <span className={styles.title_two}>News</span>
                </div>
                ...
                <div className={styles.input_block} >
                    <div className="">
                        <svg className={styles.img} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
